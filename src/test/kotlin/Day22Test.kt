...
val BRICK_A = Brick(Point(1, 0, 1), Point(1, 2, 1))
val BRICK_B = Brick(Point(0, 0, 2), Point(2, 0, 2))
val BRICK_F = Brick(Point(0, 1, 6), Point(2, 1, 6))
val BRICK_G = Brick(Point(1, 1, 7), Point(1, 1, 8))

internal class Day22Test {
    @Test
    fun should_return_correct_for_x_direction_brick() {
        val actual = generateAllPositionsToCheck(Brick(Point(0, 0, 0), Point(2, 0, 0)))
    ...
    fun should_return_correct_for_y_direction_brick() {
        val actual = generateAllPositionsToCheck(Brick(Point(0, 0, 0), Point(0, 1, 0)))
    ...
    fun should_return_correct_for_z_direction_brick() {
        val actual = generateAllPositionsToCheck(Brick(Point(2, 2, 0), Point(2, 2, 5)))
    ...
    fun should_work_when_brick_is_listed_in_reverse_order() {
        val actual = generateAllPositionsToCheck(Brick(Point(2, 0, 0), Point(0, 0, 0)))
